...
class StoryMenuState extends MusicBeatState
{
	...
	{
		return [
			['Disruption', 'AppleCore', 'Disability', 'Wireframe', 'Algebra', 'Deformation', 'Ferocious', 'Sugar-rush', 'Gift-Card', 'The-Big-Dingle', 'Dale', 'Origin', 'Apprentice', 'Resumed', 'Ready-Loud', 'Bookworm', 'Cuberoot', 'Alternate', 'Unhinged', 'Too-Shiny', 'OG', 'Sick-Tricks', 'Galactic', 'Tantalum', 'Strawberry', 'Keyboard', 'Sillier', 'Slices', 'Collision', 'Left-Unchecked', 'Poopers', 'RECOVERED-PROJECT', 'Sunshine', 'The-Boopadoop-Song', 'Thunderstorm', 'Wheels', 'Dave-X-Bambi-Shipping-Cute', 'Ticking', 'Slices']
		];
	}
